    ...
    public partial class EditarEspecialidad : ComponentBase
    {
        ...
        private async Task CargarEspecialidad()
        {
            ...
            if (resultado.Exitoso && resultado.Datos != null)
            {
                ...
                // Mapear los campos editables al DTO de actualización
                especialidadEditar.Id = especialidadOriginal.Id;
                especialidadEditar.Nombre = especialidadOriginal.Nombre;
                especialidadEditar.Descripcion = especialidadOriginal.Descripcion ?? string.Empty;
            }
            else
            {
                await Toastr.MsgInformacion("Especialidad no encontrada o error al cargar.");
        ...
        {
            var resultado = await serviciosEspecialidad.ActualizarAsync(especialidadEditar);
